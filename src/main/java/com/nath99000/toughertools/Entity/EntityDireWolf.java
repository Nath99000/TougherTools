...
import com.nath99000.toughertools.Entity.AI.ModdedAIBeg;
...
public class EntityDireWolf extends EntityTameable
{
    ...
    public EntityDireWolf(World p_i1696_1_)
    {
        ...
        this.tasks.addTask(8, new ModdedAIBeg(this, 8.0F));
        ...
        this.targetTasks.addTask(6, new EntityAITargetNonTamed(this, EntityPig.class, 200, false));
        this.targetTasks.addTask(7, new EntityAITargetNonTamed(this, EntityChicken.class, 200, false));
        this.targetTasks.addTask(8, new EntityAITargetNonTamed(this, EntityPlayer.class, 200, false));
        this.targetTasks.addTask(9, new EntityAITargetNonTamed(this, EntityDireWolf.class, 200, false));
        this.setTamed(false);
    }
