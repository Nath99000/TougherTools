package com.nath99000.toughertools.Entity.AI;
...
public class ModdedAIBeg extends EntityAIBase
{
    ...
    public ModdedAIBeg(EntityDireWolf p_i1617_1_, float p_i1617_2_)
    {
