...
public class ChestHandler {
    ...
    public static void init(){
        ...
        //item, min, max, rarity
        //dungeon
        ChestGenHooks.getInfo(ChestGenHooks.DUNGEON_CHEST).addItem(new WeightedRandomChestContent(new ItemStack(ModItems.SchematicSnowballGun), 1, 1, 12));
        ...
        //mineshaft
        ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(new WeightedRandomChestContent(new ItemStack(ModItems.SchematicSnowballGun), 1, 1, 10));
        ...
        ChestGenHooks.getInfo(ChestGenHooks.MINESHAFT_CORRIDOR).addItem(new WeightedRandomChestContent(new ItemStack(ModItems.SchematicDemonMace), 1, 1, 3));
