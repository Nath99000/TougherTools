...
public class ToolTableCraftingManager
{
    /** The static instance of this class */
    private static final ToolTableCraftingManager instance = new ToolTableCraftingManager();
     ...
     */
    public static final ToolTableCraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }

    public ToolTableCraftingManager()
    {

        recipes = new ArrayList();
        this.addRecipe(new ItemStack(ModItems.StaffLightning, 1), new Object[] {"DDD", "DDD", " DDD", "DDD", 'D', new ItemStack(Items.diamond), 'I', new ItemStack(Items.iron_ingot)});

        Collections.sort(this.recipes, new ToolTableRecipeSorter(this) {
        });
    }

    public ToolTableShapedRecipe addRecipe(ItemStack p_92103_1_, Object ... p_92103_2_)
    {
        String s = "";
        int i = 0;
        int j = 0;
        ...
        ToolTableShapedRecipe shapedrecipes = new ToolTableShapedRecipe(j, k, aitemstack, p_92103_1_);
        this.recipes.add(shapedrecipes);
        return shapedrecipes;
    }

    public void addShapelessRecipe(ItemStack stack, Object ... p_77596_2_)
    {
